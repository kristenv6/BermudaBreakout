...
public class Apple1Pickup : MonoBehaviour
{
    GameObject foodItem;
    ...
    void Start()
    {
      foodItem = GameObject.Find("Apple1");  
    ...
    private void UserPicksUp()
    {
        ...
        Debug.Log("apple1: looking for " + "Heart" + GameStats.heartNum.ToString());
        ...
        if (heart) {
          ...
          Debug.Log("HEART ACTIVATED WITH APPLE 1");
